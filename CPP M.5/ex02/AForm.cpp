...
/*   Updated: 2023/10/26 17:04:05 by bel-kdio         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm() : name(""), grade_s(150) , grade_e(50){};
...
AForm::AForm(const AForm& obj) : name(obj.name), grade_e(obj.grade_e), grade_s(obj.grade_s), signe(obj.signe){};
